...
public class Match {
    ...
    public Match(int matchId, String teamHeading, String matchNumberVenue,
                 String battingTeam, String battingTeamScore, String bowlTeam,
                 String bowlTeamScore, String liveText, String matchLink,
    ...
    // set the matchStatus according to the textComplete
